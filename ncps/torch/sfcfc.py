...
from . import CfCCellSlowFastOnline, WiredCfCCellSlowFastOnline
...
class SFcfc(nn.Module):
    def __init__(
        ...
        if isinstance(units, ncps.wirings.Wiring):
            ...
            self.rnn_cell = WiredCfCCellSlowFastOnline(
                input_size,
            ...
            self.rnn_cell = CfCCellSlowFastOnline(
                input_size,
                self.wiring_or_units,
                mode,
                activation,
